...
from restapi.ChatbotException import ChatbotException, InternalServerError
...
api = CustomApi(version='0.1', title='Chatbot Service',
                description='Chatbot Service', catch_all_404s=True)